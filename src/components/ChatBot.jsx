...
//         ...prev,
//         {
//           text: "Please sign in to make a booking.",
//           sender: "bot",
//         },
//       ]);
...
//               ...prev,
//               {
//                 text: "This vehicle number already has a booking. Please use a different vehicle number.",
//                 sender: "bot",
//               },
//             ]);
//             return;
...
//             ...prev,
//             {
//               text: "Select vehicle type: (type '2' for two-wheeler or '4' for four-wheeler)",
//               sender: "bot",
//             },
//           ]);
//           setBookingStep(3);
...
//                 ...prev,
//                 {
//                   text: "Select charging type: (type 'AC' or 'DC')",
//                   sender: "bot",
//                 },
//               ]);
//               setBookingStep(4);
...
//               ...prev,
//               {
//                 text: "Please enter either '2' for two-wheeler or '4' for four-wheeler",
//                 sender: "bot",
//               },
//             ]);
//           }
...
//               ...prev,
//               {
//                 text: "Please enter either 'AC' or 'DC'",
//                 sender: "bot",
//               },
//             ]);
//           }
...
//                 ...prev,
//                 {
//                   text: "You have reached the maximum limit of 3 bookings.",
//                   sender: "bot",
//                 },
//               ]);
//               setIsBookingSlot(false);
...
//               ...prev,
//               {
//                 text: "Please select a valid time slot from the list above.",
//                 sender: "bot",
//               },
//             ]);
//           }
...
//       <div className="flex flex-col w-full max-w-md p-4 bg-white/80 shadow-lg rounded-lg mt-10 mb-4 space-y-4 overflow-auto h-3/4">
//         <h1 className="text-lg font-bold text-green-800 text-center mb-2">
...
//                 : "bg-green-200 text-green-900 self-start"
//             }`}
//           >
...
//       <div className="flex w-full max-w-md p-2 bg-white/90 rounded-lg shadow-md space-x-2 items-center mb-6">
//         <input
//           type="text"
//           value={input}
//           onChange={(e) => setInput(e.target.value)}
//           onKeyDown={(e) => e.key === "Enter" && sendMessage(input)}
//           className="w-full p-3 text-lg text-green-800 border-2 border-green-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500"
//           placeholder="Type your message..."
//         />
//         <button
//           onClick={() => sendMessage(input)}
//           className="p-3 text-white bg-green-500 rounded-lg shadow-sm hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400"
//         >
//           Send
//         </button>
//       </div>
